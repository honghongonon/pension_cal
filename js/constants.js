...
const CONSTANTS = {
  ...
  NATIONAL_PENSION: {
    ...
    // 추납 효과 분석 관련
    MAX_ADDITIONAL_MONTHS: 119,     // 추납 가능 최대 기간 (10년 미만, 2020.12 개정)
  ...
  RETIREMENT_PENSION: {
    ...
    SALARY_THRESHOLD: 55000000,          // 총급여 기준 (연말정산)
    INCOME_THRESHOLD: 45000000,          // 종합소득금액 기준 (종소세 신고)
    ...
    RETIREMENT_INCOME_DEDUCTION: {
      ...
      OVER_20: { BASE: 43000000, ADD: 3000000 },  // 20년 초과: 4300만 + 300만×(근속-20)
    },
  ...
  HEALTH_INSURANCE: {
    ...
    REGIONAL: {
      ...
      CAR_SCORE: {
        // 2024.02부로 지역가입자 자동차 보험료 전면 폐지
        UNDER_1600: 0,
        OVER_1600_UNDER_3000: 0,
        OVER_3000: 0,
      },
    },
